...
func (userService Service) Users() ([]Response, error) {
	userContainer := usersResponse{}
	err := userService.queryUsers(&userContainer, "")
	if err != nil {
		return nil, err
	}

	return userContainer.Users, nil
}

func (userService Service) GetUserByName(name string) (Response, error) {
